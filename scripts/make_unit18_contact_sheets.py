#!/usr/bin/env python3
"""Create bounded contact sheets for visual review of all Units 1-18 pages."""
...
OUTPUT_DIR = ROOT / "tmp" / "pdfs" / "unit-18-release-contact"
PAGES_PER_SHEET = 20
COLUMNS = 5
THUMB_WIDTH = 240
LABEL_HEIGHT = 30
...
def main() -> int:
    ...
    if len(pages) != 320:
        raise RuntimeError(f"expected 320 pages, found {len(pages)}")
