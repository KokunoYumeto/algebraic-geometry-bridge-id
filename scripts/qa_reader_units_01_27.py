#!/usr/bin/env python3
"""Fail-closed cumulative reader QA through the Unit 27 milestone.

The accepted Unit 24 reader QA remains byte-pinned and supplies the cumulative
coverage baseline. Only Units 25--27 are replayed as new source/authority
inputs. Set AG_BRIDGE_SPECIALIZE_ONLY=1 for an in-memory compile check.
"""
...
def replace_once(text: str, old: str, new: str) -> str:
    ...
    if count != 1:
        raise SystemExit(
            f"Unit 27 reader-QA specialization expected one occurrence, found {count}: {old!r}"
        )
...
generated = replace_once(
    ...
    '''BASELINE_FACTS = {
    "qa/UNITS_01_24_MACHINE_QA.json": (4457, "8c9e0fdf4817c6fef955007abdca4b49eb4e3dbddcc12804b04646ac1ac3dbd3"),
    "qa/UNIT_24_PROTECTED_SURFACES.json": (4127, "afcb17362e90f8492b78eeaf5022f0bca1ee193c2ee1cff6ed0e33f235622580"),
}''',
)

for old, new in (
    ("algebraic-geometry-bridge-id-units-01-24.pdf", "algebraic-geometry-bridge-id-units-01-27.pdf"),
    ("frontmatter-units-01-24.md", "frontmatter-units-01-27.md"),
    ("Kurva Aljabar - Unit 1-24", "Kurva Aljabar - Unit 1-27"),
    ("authority_units_22_24", "authority_units_25_27"),
...
generated = replace_once(
    ...
    'OUT = ROOT / "qa" / "UNITS_01_27_MACHINE_QA.json"',
)

generated = generated.replace(
    'baseline = json.loads((ROOT / "qa" / "UNITS_01_21_MACHINE_QA.json").read_text(encoding="utf-8"))',
    'baseline = json.loads((ROOT / "qa" / "UNITS_01_24_MACHINE_QA.json").read_text(encoding="utf-8"))',
)
generated = generated.replace(
    'protected_baseline = json.loads((ROOT / "qa" / "UNIT_21_PROTECTED_SURFACES.json").read_text(encoding="utf-8"))',
    'protected_baseline = json.loads((ROOT / "qa" / "UNIT_24_PROTECTED_SURFACES.json").read_text(encoding="utf-8"))',
)
generated = replace_once(
    generated,
...
generated = generated.replace(
    ...
    'baseline.get("status") == "PASS" and baseline.get("through_unit") == 24',
)
generated = generated.replace(
    'protected_baseline.get("status") == "PASS" and protected_baseline.get("through_unit") == 21',
    'protected_baseline.get("status") == "PASS" and protected_baseline.get("through_unit") == 24',
)
generated = generated.replace("Unit 21 machine baseline", "Unit 24 machine baseline")
generated = generated.replace("Unit 21 protected baseline", "Unit 24 protected baseline")
generated = generated.replace("exact Units 1-21 machine/protected baselines bound", "exact Units 1-24 machine/protected baselines bound")
generated = replace_once(
    generated,
...
generated = generated.replace('build.get("through_unit") == 24', 'build.get("through_unit") == 27')
generated = generated.replace("set(range(1, 25))", "set(range(1, 28))")
generated = generated.replace("range(22, 25)", "range(25, 28)")
generated = generated.replace("pdf_boundaries[22]", "pdf_boundaries[25]")
...
if os.environ.get("AG_BRIDGE_SPECIALIZE_ONLY") == "1":
    ...
    print("Unit 27 reader-QA specialization: COMPILE PASS")
else:
