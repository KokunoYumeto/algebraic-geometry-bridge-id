#!/usr/bin/env python3
"""Freeze Unit 5 Commons media and emit component-level rights records."""
...
META = ROOT / "authority" / "commons-imageinfo-unit-05.json"
RIGHTS = ROOT / "authority" / "RIGHTS-unit-05.csv"
CLOSURE = ROOT / "authority" / "ASSET_CLOSURE-unit-05.json"
CREDITS = ROOT / "source" / "id-ID" / "media-credits-unit-05.md"
API = "https://commons.wikimedia.org/w/api.php"
USER_AGENT = "Codex algebraic-geometry-bridge-id media freeze (at user's direction)"

MEDIA = (
    {
        "resource_title": "File:Kuzel_obecny.svg",
        "metadata_title": "File:Kuzel obecny.svg",
        "caption": "Sebuah kerucut (himpunan nol dari polinom homogen)",
        "credit_creator": "Pajs di Wikipedia bahasa Ceko",
        "credit_status": "domain publik",
        "local_name": "Kuzel_obecny.svg",
        "pdf_name": "Kuzel_obecny-500.png",
    },
    {
        "resource_title": "File:Noether.jpg",
        "metadata_title": "File:Noether.jpg",
        "caption": "Emmy Noether (1882-1935)",
        "credit_creator": "pencipta tidak diketahui; sumber/penerbit dicatat pada halaman Commons",
        "credit_status": "domain publik",
        "local_name": "Noether.jpg",
        "pdf_name": "",
    },
    {
        "resource_title": "File:Elipsoid_trojosy321.png",
        "metadata_title": "File:Elipsoid trojosy321.png",
        "caption": "Elipsoid tiga sumbu dengan perbandingan semisumbu 3:2:1",
        "credit_creator": "Pajs di Wikipedia bahasa Ceko",
        "credit_status": "domain publik",
        "local_name": "Elipsoid_trojosy321.png",
        "pdf_name": "",
    },
)
...
def main() -> int:
    ...
    for order, item in enumerate(MEDIA, start=1):
        ...
        rows.append(
            {
                "asset_id": f"br-ak-u05-media-{order:03d}",
                "reader_order": order,
    ...
    credit_lines = [
        "# Kredit media Unit 5 {#agc-media-credits-unit-05}",
        "",
